...
ankit_image = face_recognition.load_image_file("Ankit/Ankit.jpg")
...
harshil_image = face_recognition.load_image_file("Harshil/Harshil.jpg")
harshil_face_encoding = face_recognition.face_encodings(harshil_image)[0]
